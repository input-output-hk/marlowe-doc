...
services:
  ...
  chain-indexer:
    ...
    depends_on:
      ...
      postgres:
        condition: service_healthy
    image: ghcr.io/input-output-hk/marlowe-chain-indexer:0.0.1
    user: 0:0
    restart: unless-stopped
    volumes:
    - shared:/ipc
  ...
  chain-sync:
    ...
    depends_on:
      ...
      postgres:
        condition: service_healthy
    image: ghcr.io/input-output-hk/marlowe-chain-sync:0.0.1
    user: 0:0
    restart: unless-stopped
    volumes:
    - shared:/ipc
  ...
  indexer:
    ...
    depends_on:
      ...
      postgres:
        condition: service_healthy
    image: ghcr.io/input-output-hk/marlowe-indexer:0.0.1
    restart: unless-stopped
  ...
  sync:
    ...
    depends_on:
      ...
      postgres:
        condition: service_healthy
    image: ghcr.io/input-output-hk/marlowe-sync:0.0.1
    restart: unless-stopped
  ...
  tx:
    ...
    depends_on:
      - chain-sync
    image: ghcr.io/input-output-hk/marlowe-tx:0.0.1
    restart: unless-stopped
  ...
  proxy:
    ...
    depends_on:
      - sync
      - tx
    image: ghcr.io/input-output-hk/marlowe-proxy:0.0.1
    restart: unless-stopped
    ports:
    - 3700:3700
  ...
  web-server:
    ...
    depends_on:
      - proxy
    image: ghcr.io/input-output-hk/marlowe-web-server:0.0.1
    restart: unless-stopped
    ports:
    - 3780:3780
