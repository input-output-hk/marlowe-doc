...
In this tutorial, you will deploy Marlowe Runtime with Docker in a Nix environment. Nix will provide a turn-key way to run all the services shown in this [architecture diagram](./docs/architecture).
